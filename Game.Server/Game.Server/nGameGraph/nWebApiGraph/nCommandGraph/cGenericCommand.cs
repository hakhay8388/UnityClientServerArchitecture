...
using Game.Server.nUtils.nJsonConverter;
...
namespace Game.Server.nGameGraph.nWebApiGraph.nCommandGraph
{
    public class cGenericCommand : cBaseCommand
    {
                ...
                : base(_Graph, _Command)
        {
            try
            {
                CommandDataClass = Type.GetType("Game.Server.nGameGraph.nWebApiGraph.nCommandGraph.nCommands.n" + CommandID.Name + "Command.c" + CommandID.Name + "CommandData");
                CommandReceiverClass = Type.GetType("Game.Server.nGameGraph.nWebApiGraph.nCommandGraph.nCommands.n" + CommandID.Name + "Command.I" + CommandID.Name + "Receiver");
            }
            catch (Exception _Ex)
            {
            }
